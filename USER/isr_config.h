...
#define CCU6_0_CH0_ISR_PRIORITY 254	//定义CCU6_0 PIT通道0中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样

#define CCU6_0_CH1_INT_SERVICE	1
#define CCU6_0_CH1_ISR_PRIORITY 253
...
#define UART3_TX_INT_PRIO  251
#define UART3_RX_INT_PRIO  252
#define UART3_ER_INT_PRIO  253
