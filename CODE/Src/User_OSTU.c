...
/***************************************************************
*
* 函数名称：uint8_t GetOSTU(uint8_t tmImage[MT9V03X_H][MT9V03X_W])
* 功能说明：求阈值大小
* 参数说明：
* 函数返回：阈值大小
* 修改时间：2018年3月27日
...
***************************************************************/
uint16_t GetOSTU(uint8_t tmImage[MT9V03X_H][MT9V03X_W])  //返回值原为uint8_t
{
  uint32_t Amount = 0;
...
/***************************************************************
*
* 函数名称：void BinaryImage(uint8_t tmImage[MT9V03X_H][MT9V03X_W])
* 功能说明：图像数据二值化
* 参数说明：
* 函数返回：void
* 修改时间：2018年3月27日
